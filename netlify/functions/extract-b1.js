// extract-b1.js — Project Risk terms (10 terms)
...
const PROMPT_B1 = `You are an expert energy procurement analyst extracting facts from a VPPA/PPA term sheet.
...

{
  "terms": {
    ...
    "conditions": { "snapshot": "e.g. '3 CPs listed' or 'None'", "summary": "Conditions precedent — list all seller CPs, note which (if any) are already satisfied at signing. Note any interconnection or financing CPs specifically.", "confidence": "high|medium|low", "sourceText": "verbatim excerpt or null" },
    "delay": { "snapshot": "e.g. '$150/MW/day, capped' or 'Not addressed'", "summary": "COD delay damages — rate per MW per day, grace period, aggregate cap, long-stop date, buyer termination right.", "confidence": "high|medium|low", "sourceText": "verbatim excerpt or null" },
...
exports.handler = async (event) => {
  ...
  try {
    const result = await callHaiku(PROMPT_B1, `Extract facts from this VPPA/PPA term sheet:\n\n${text.substring(0, 20000)}`);
