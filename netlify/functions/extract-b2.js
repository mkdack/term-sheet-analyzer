// extract-b2.js — Legal & Admin terms (10 terms)
...
const PROMPT_B2 = `You are an expert energy procurement analyst extracting facts from a VPPA/PPA term sheet.
...
exports.handler = async (event) => {
  ...
  try {
    const result = await callHaiku(PROMPT_B2, `Extract facts from this VPPA/PPA term sheet:\n\n${text.substring(0, 20000)}`);
